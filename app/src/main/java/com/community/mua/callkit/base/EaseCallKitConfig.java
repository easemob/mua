...
public class EaseCallKitConfig {
    ...
    private Map<String, com.community.mua.callkit.base.EaseCallUserInfo> userInfoMap = new HashMap<>();
    ...
    public Map<String, com.community.mua.callkit.base.EaseCallUserInfo> getUserInfoMap() {
        return userInfoMap;
    }

    public void setUserInfoMap(Map<String, com.community.mua.callkit.base.EaseCallUserInfo> userMap) {
        userInfoMap.clear();
        if(userMap != null && userMap.size() > 0){
            Set<String> userSet = userMap.keySet();
            for(String userId:userSet){
                com.community.mua.callkit.base.EaseCallUserInfo userInfo = userMap.get(userId);
                if(userInfo != null){
                    com.community.mua.callkit.base.EaseCallUserInfo newUserInfo = new com.community.mua.callkit.base.EaseCallUserInfo(userInfo.getNickName(),userInfo.getHeadImage());
    ...
    public void setUserInfo(String userName, com.community.mua.callkit.base.EaseCallUserInfo userInfo){
        if(userInfoMap == null){
