...
public class EaseCallMemberView extends RelativeLayout {
    ...
    private com.community.mua.callkit.base.EaseUserAccount userInfo;
    ...
    public void setUserInfo(UserInfo info){
        ...
        com.community.mua.callkit.base.EaseUserAccount account = new com.community.mua.callkit.base.EaseUserAccount(info.uid, info.userAccount);
        setUserInfo(account);
    }

    public void setUserInfo(com.community.mua.callkit.base.EaseUserAccount info) {
        userInfo = info;
        updateUserInfo();
    }
    ...
    public void updateUserInfo(){
        if(userInfo != null){
            nameView.setText(EaseCallKitUtils.getUserNick(userInfo.getUserName()));
    ...
    public com.community.mua.callkit.base.EaseUserAccount getUserInfo(){
        return  userInfo;
    }
    ...
    public void setUsername(String username) {
        ...
        nameView.setText(EaseCallKitUtils.getUserNick(username));
    }
