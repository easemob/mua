package com.community.mua.callkit.livedatas;
 ...
 */
public final class EaseLiveDataBus {

    private final Map<String, BusMutableLiveData<Object>> bus;

    private EaseLiveDataBus() {
        bus = new HashMap<>();
    }

    private static class SingletonHolder {
        private static final EaseLiveDataBus DEFAULT_BUS = new EaseLiveDataBus();
    }

    public static EaseLiveDataBus get() {
