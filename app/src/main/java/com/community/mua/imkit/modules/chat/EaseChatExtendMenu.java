...
import com.community.mua.imkit.adapter.EaseChatExtendMenuAdapter;
import com.community.mua.imkit.adapter.EaseChatExtendMenuIndicatorAdapter;
import com.community.mua.imkit.interfaces.OnItemClickListener;
import com.community.mua.imkit.modules.chat.interfaces.EaseChatExtendMenuItemClickListener;
import com.community.mua.imkit.modules.chat.interfaces.IChatExtendMenu;
import com.community.mua.imkit.widget.chatextend.HorizontalPageLayoutManager;
import com.community.mua.imkit.widget.chatextend.PagingScrollHelper;
...
public class EaseChatExtendMenu extends FrameLayout implements PagingScrollHelper.onPageChangeListener, IChatExtendMenu, OnItemClickListener {
    ...
    private int[] itemStrings = { R.string.attach_take_pic, R.string.attach_picture,
            R.string.attach_location, R.string.attach_video,R.string.attach_movie /*,R.string.attach_file*/};
    private int[] itemdrawables = { R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.em_chat_video_selector, R.drawable.em_chat_movie_selector/*,R.drawable.em_chat_file_selector*/};
    private int[] itemIds = { R.id.extend_item_take_picture, R.id.extend_item_picture, R.id.extend_item_location, R.id.extend_item_video, R.id.extend_item_movie/*,R.id.extend_item_file*/};
    ...
    private void initLayout() {
        ...
        mLinearLayout = findViewById(R.id.ll_extend_menu);
    ...
    private void initChatExtendMenu() {
        ...
        rvExtendMenu.setHasFixedSize(false);
    ...
    public void setMenuBackground(Drawable bg) {
        mLinearLayout.setBackground(bg);
    }
