...
import com.community.mua.imkit.interfaces.EaseChatRoomListener;
import com.community.mua.imkit.interfaces.EaseGroupListener;
...
import com.community.mua.imkit.modules.chat.interfaces.ChatInputMenuListener;
import com.community.mua.imkit.modules.chat.interfaces.IChatLayout;
...
import com.community.mua.imkit.modules.chat.interfaces.OnRecallMessageResultListener;
...
import com.community.mua.imkit.modules.chat.presenter.IHandleMessageView;
import com.community.mua.imkit.modules.interfaces.IPopupWindow;
import com.community.mua.imkit.modules.menu.EasePopupWindow;
...
import com.community.mua.imkit.widget.EaseAlertDialog;
...
//        }
    ...
    private void setMenuByMsgType(View v, EMMessage message) {
        ...
        menuHelper.findItemVisible(com.community.mua.R.id.action_chat_label,true);
        if (!isReportYourSelf){
            menuHelper.findItemVisible(com.community.mua.R.id.action_chat_label, message.direct() == EMMessage.Direct.RECEIVE ? true : false);
        }
        switch (type) {
            case TXT:
                EMTranslationResult result = EMClient.getInstance().translationManager().getTranslationResult(message.getMsgId());
