...
import com.community.mua.imkit.adapter.EaseMessageAdapter;
...
import com.community.mua.imkit.modules.chat.interfaces.IChatMessageItemSet;
import com.community.mua.imkit.modules.chat.interfaces.IChatMessageListLayout;
import com.community.mua.imkit.modules.chat.interfaces.IRecyclerViewHandle;
import com.community.mua.imkit.modules.chat.model.EaseChatItemStyleHelper;
...
import com.community.mua.imkit.modules.chat.presenter.IChatMessageListView;
...
//    }
    ...
    public void setChatBg(int chatBg) {
        BitmapDrawable drawable = (BitmapDrawable) getResources().getDrawable(R.drawable.bg_chat);
        drawable.setBitmap(Utils.getBitmap(getContext(), chatBg));
        rvList.setBackground(drawable);
    }

    public void setChatBgColor(Drawable bg) {
        rvList.setBackground(bg);
    }
