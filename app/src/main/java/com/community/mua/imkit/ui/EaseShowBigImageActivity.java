...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (EaseFileUtils.isFileExistByUri(this, mUri)) {
            Glide.with(this).load(mUri).into(image);
        } else if (msgId != null) {
            downloadImage(msgId);
        } else {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (!isFinishing() && !isDestroyed()) {
                            ...
                            isDownloaded = true;
                            mUri = ((EMImageMessageBody) msg.getBody()).getLocalUri();
