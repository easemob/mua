...
import com.community.mua.imkit.utils.EaseVoiceLengthUtils;
...
public class EaseChatRowVoice extends EaseChatRowFile {
    ...
    protected void onSetUpView() {
        ...
        if (!showSenderType) {
            voiceImageView.setImageResource(R.drawable.wave_gray_static);
    ...
    public void startVoicePlayAnimation() {
        voiceImageView.setImageResource(R.drawable.voice_anim);
//        if (message.direct() == EMMessage.Direct.RECEIVE) {
