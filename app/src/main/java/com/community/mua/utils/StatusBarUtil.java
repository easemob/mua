...
public class StatusBarUtil {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentFullScreen(Activity activity, View needOffsetView) {
        setTranslucentFullScreen(activity, DEFAULT_STATUS_BAR_ALPHA, needOffsetView);
    }
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentFullScreen(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha,
                                                View needOffsetView) {
